...
@Autonomous(name = "LinearParkingPrayToZach", group = "WTR")
//@Disabled
public class LinearParkingPrayToZach extends LinearOpMode {
...
//randall is a potato.
    ...
    public void runOpMode(){
        ...
        //telemetry.addData("Important Status Update", "Randall is a potato.");

        //LinearGetJewel.runOpMode();
